...
import { fetchPlayerCharacters, fetchUserDetails } from '../../actions/profile_index';
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <Divider />
                <Dropdown placeholder='Character' fluid selection options={characterOptions} loading={this.props.fetchingCharacters} />
            </Segment>
        )
    }
}
...
export default connect(mapStateToProps, { fetchPlayerCharacters, fetchUserDetails })(Stats)
