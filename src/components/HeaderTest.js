...
const betaPopupContent = {
  render() {
    return (
      <div>
        Many of these features are still under development, so you may see some
        bugs!
...
const themeStyles = {
  green: {
    text: "Green",
    sidebarColor: { backgroundColor: "#272727" },
    iconColor: { color: "#f5f5f5" },
    headerBackground: { backgroundColor: "#14a76c" },
    heartColor: { color: "#D82B30" },
    backgroundImage: { backgroundImage: `url(${ArcstriderDark})` },
    labelColor: { color: "#212121", backgroundColor: "#F1C42E" }
  },
  yellow: {
    text: "Yellow",
    sidebarColor: { backgroundColor: "#3A3A3B" },
    iconColor: { color: "#c5c6c7" },
    headerBackground: { backgroundColor: "#F7B831" },
    heartColor: { color: "#D82B30" },
    backgroundImage: { backgroundImage: `url(${ArcstriderDark})` },
    labelColor: { color: "#212121", backgroundColor: "#F7B831" }
  },
  red: {
    text: "Red",
    sidebarColor: { backgroundColor: "#212121" },
    iconColor: { color: "#f5f5f5" },
    headerBackground: { backgroundColor: "#E74C3C" },
  ...
  seaGreen: {
    text: "Sea Green",
    sidebarColor: { backgroundColor: "#202933" },
    iconColor: { color: "#c5c6c7" },
    headerBackground: { backgroundColor: "#49A29D" },
    heartColor: { color: "#E74C3C" },
    backgroundImage: { backgroundImage: `url(${ArcstriderDark})` },
    labelColor: { color: "#212121", backgroundColor: "#F1C42E" }
  },
  blue: {
    text: "Blue",
    sidebarColor: { backgroundColor: "#2f4454" },
    iconColor: { color: "#c5c6c7" },
    headerBackground: { backgroundColor: "#C5C6C7" },
    heartColor: { color: "#ff695e" },
    backgroundImage: { backgroundImage: `url(${ArcstriderDark})` },
    labelColor: { color: "#212121", backgroundColor: "#F1C42E" }
  },
  whiteBlack: {
    text: "Blue",
    sidebarColor: { backgroundColor: "#f5f5f5" },
    iconColor: { color: "#212121" },
    headerBackground: { backgroundColor: "#C5C6C7" },
    heartColor: { color: "#ff695e" },
    backgroundImage: { backgroundImage: `url(${ArcstriderDark})` },
    labelColor: { color: "#212121", backgroundColor: "#F1C42E" }
    ...
    return (
      <Sidebar.Pushable as={Segment} style={currentTheme.backgroundImage}>
        ...
        <Sidebar
          ...
          inverted
          compact
          style={currentTheme.sidebarColor}
        >
          {/* <Menu.Item name='logo' >
                        <Image
                            src={Logo}
          ...
          <Popup
            trigger={
              <Menu.Item
                ...
                to="/"
                name="home"
                style={currentTheme.headerBackground}
              >
          ...
          <Popup
            trigger={
              <Menu.Item as={Link} to="/lfg" name="lfg">
                <Icon
                  name="comments"
                  size="large"
                  inverted
          ...
          <Popup
            ...
            content={
              <Menu icon borderless fluid widths={5}>
                <Menu.Item
                  href="//twitter.com/destinderdotcom"
                  target="_blank"
                  name="twitter"
                >
                  <Icon
                ...
                <Menu.Item
                  href="//instagram.com/destinderdotcom"
                  target="_blank"
                  name="instagram"
                >
                  <Icon
                ...
                <Menu.Item
                  href="//www.reddit.com/r/destinder/"
                  target="_blank"
                  name="reddit"
                >
                  <Icon
                ...
                <Menu.Item
                  href="//github.com/destiny-aviato/destinder"
                  target="_blank"
                  name="github"
                >
          ...
          <Popup
            trigger={
              <Label attached="bottom" style={currentTheme.labelColor}>
                BETA
              </Label>
            }
            header="Heads up!"
            content={
              <div>
                Many of these features are still under development, so you may
                see some bugs!
                <Divider />
                <Button
                  href="mailto:help@destinder.com"
                  animated
                  style={{ backgroundColor: "#45a29e", color: "#f5f5f5" }}
                >
        ...
        <Sidebar.Pusher>
          ...
          />
          <Divider
            className="hide-on-med-and-up header-divider"
