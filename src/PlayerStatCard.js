    ...
    <div>
      <Card style={{ boxShadow: "none" }}>
        <Card.Content style={{ padding: "0" }}>
          <Popup
            trigger={
              <Label as="a" color="teal" corner="right">
          ...
          <Card.Header style={{ display: "none" }}>
            <Segment
              ...
              style={{
                backgroundImage: `url(${props.data.emblem_background})`
              }}
            >
            ...
            >
              <Segment circular style={{ width: 50, height: 50 }}>
                <Header as="h2" style={{ color: "#212121" }}>
                  ...
                  <Header.Subheader>K/D</Header.Subheader>
                </Header>
              </Segment>
            </div>
          </Card.Meta>
          <Card.Description style={{ padding: "10px" }}>
            ...
            <Popup
              trigger={
                ...
                >
                  <Image src={props.data.subclass_icon} avatar size="mini" />
                  {props.data.subclass}
                </div>
              }
            ...
            <div style={{ padding: "15px" }}>
              {
                <KillChart
                  key={`${props.data.player_name}${props.data.character_type}`}
                  data={props.data.recent_games}
                />
              }
              <div
                style={{
              ...
              <Grid.Row>
                <Grid.Column>
                  <Header as="h4" style={{ color: "#212121" }}>
                    ...
                    <Header.Subheader>KA/D</Header.Subheader>
                  </Header>
                </Grid.Column>
                <Grid.Column>
                  <Header as="h4" style={{ color: "#7198B7" }}>
                    {props.data.stats[0].elo.value}
                    <Header.Subheader>ELO</Header.Subheader>
                  </Header>
                </Grid.Column>
                <Grid.Column>
                  <Header as="h4" style={{ color: "#212121" }}>
                    {props.data.stats[0].win_rate}
                    <Header.Subheader>WIN %</Header.Subheader>
                  </Header>
                </Grid.Column>
              </Grid.Row>
            </Grid>
                ...
                <Popup
                  trigger={
                    <Image
                      ...
                      bordered
                      src={props.data.items[0].primary_weapon_1.item_icon}
                    />
                  }
                ...
                <Popup
                  trigger={
                    <Image
                      style={{ borderRadius: "4px" }}
                      bordered
                      src={props.data.items[0].primary_weapon_2.item_icon}
                    />
                  }
                ...
                <Popup
                  trigger={
                    <Image
                      style={{ borderRadius: "4px" }}
                      bordered
                      src={props.data.items[0].power_weapon.item_icon}
                    />
                  }
